...
The skill challenges commander choice, color identity, named finishers, copy or mill math, Game Changers, tutors, and Oracle text. It does not write `decklist.txt` until that plan is locked. If the user already posted a complete list, skip this skill and use `deck-workspace`.
