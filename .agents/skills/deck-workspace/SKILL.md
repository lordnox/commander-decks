...
- Assessed decks use `decks/<N><modifier>_<slug>/`, with ASCII `-`, no modifier, or `+` for positions `N−`, `N`, or `N+`. Examples: `3-_mishra-racecar-driver`, `3_bartolome-funeral-director`, and `3+_ozox-bone-recycler`.
