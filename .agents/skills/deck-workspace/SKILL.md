...
When recommending swaps, follow the root `DECISIONS.md` card preferences: staples are flour, so avoid the ones that dilute identity while lands and two-mana rocks stay exempt; esoteric on-theme cards as a tiebreaker; discussable Game Changers; kitchen-table fast mana.
