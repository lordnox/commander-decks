...
browser for the felt table, life totals, stack, 101-step slider, fixed
transport controls, collapsible event log, and card art on hover. GitHub will
not render it inline, so download the file or clone.
