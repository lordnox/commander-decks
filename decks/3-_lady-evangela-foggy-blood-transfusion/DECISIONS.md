...
- **Sol Ring** — Fast colorless that accelerates the tax and counter shell.
...
- **Turn-seven X-spell** is the high-roll *threat*, not the high-roll table kill: Sol Ring into Map into Coffers, then Urborg and a Swamp-trigger creature, can present a large X while opponents are still in the 30s. Lethal from 40 on that turn needs the Rings loop or an earlier exchange.
