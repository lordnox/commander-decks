...
- **Minamo, School at Water's Edge** — Left the 99 for **Teferi, Who Slows the Sunset**. Minamo only untaps legendary permanents, so it never hit Coffers or Magus; Teferi's +1 hits both plus a rock and gains 2 life. Lands go 38 → 37. Cryptic Command was the other candidate ( `{1}{U}{U}{U}` is the hardest remaining cost) and stayed so the protection suite does not shrink again.
...
- **Everybody Lives! stops life loss, not just combat damage.** Paying life, Wall of Blood, and a downward life exchange all fail while it applies. Exsanguinate and Debt to the Deathless also do nothing that turn, which is why it is a panic button rather than a fog you cast on your own drain turn. Players can still concede.
