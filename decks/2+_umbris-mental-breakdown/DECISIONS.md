...
- **Scrib Nibblers** — Exiles cards one at a time and untaps when an exiled card is a land.
...
- **Elspeth's Nightmare** — Removes a small creature, attacks a hand, and eventually converts an opposing graveyard into Umbris power.
...
- **Darksteel Ingot** — Provides durable five-colour mana for stolen spells.
...
- **Jester's Scepter** — Exiles five cards on entry and turns matching cards into countermagic.
...
- **Muse Vessel** — Slowly removes chosen cards from hands and allows any previously stored card to be played.
- **Ornate Kanzashi** — A repeatable old theft engine that turns spare mana into an opposing top card.
...
- **Spectral Searchlight** — Produces any colour and can make a political mana gift when that changes an opponent's decision.
...
- **Vessel of Endless Rest** — Fixes any colour and removes a recursion target while entering.
...
- **Parallel Thoughts** — Banks seven chosen cards and offers a replacement effect that can still put them into hand through Shared Fate.
- **Petals of Insight** — Places cards directly into hand and can be repeated until the preferred group appears.
...
- **Opponent-owned exile.** Umbris counts cards opponents own regardless of which player exiled them or whether they are face down. It does not count this deck's cards exiled by Parallel Thoughts or another effect.
...
- **Parallel Thoughts.** When this deck would draw while both enchantments apply, it chooses which replacement effect applies. Choosing Parallel Thoughts puts its top piled card into hand without invoking Shared Fate.
