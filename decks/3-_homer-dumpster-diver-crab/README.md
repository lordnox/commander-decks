...
Use [**Crawling Sensation**](https://scryfall.com/card/tdc/252/crawling-sensation?utm_source=api), [**Perpetual Timepiece**](https://scryfall.com/card/soc/354/perpetual-timepiece?utm_source=api), [**Ripples of Undeath**](https://scryfall.com/card/mh3/107/ripples-of-undeath?utm_source=api), [**Life from the Loam**](https://scryfall.com/card/tdc/96/life-from-the-loam?utm_source=api), [**Satyr Wayfinder**](https://scryfall.com/card/eoc/106/satyr-wayfinder?utm_source=api), [**Millikin**](https://scryfall.com/card/soc/351/millikin?utm_source=api), [**Skull Prophet**](https://scryfall.com/card/tdc/304/skull-prophet?utm_source=api), [**Six**](https://scryfall.com/card/mh3/169/six?utm_source=api), and [**Blossoming Tortoise**](https://scryfall.com/card/woe/163/blossoming-tortoise?utm_source=api) to fill the graveyard. [Crawling Sensation](https://scryfall.com/card/tdc/252/crawling-sensation?utm_source=api) is intentionally slower than the previous mass-mill engine, but turns milled lands into expendable Insects.
