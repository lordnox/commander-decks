...
1. Attach a return Aura to Sun Titan or another compatible recursion creature.
...
Angelic Renewal can fill the same role when the returning creature can immediately recover it.
...
### Bontu's Monument + Phyrexian Altar + Ozox

Bontu's Monument reduces Ozox to {1}{B}. Sacrificing Ozox and Jumblebones to Phyrexian Altar produces the two mana needed to recast Ozox. Every cast drains the table through Bontu's Monument.

Bartolomé is not required for this line, which gives the deck a combo that survives commander removal.

### Ashnod's Altar + Bog Initiate + Ozox
...
Sun Titan is the clearest example:

1. Enchant Sun Titan with Fungal Fortitude, Kaya's Ghostform, Minion's Return, or Necrogen Communion.
2. Sacrifice Sun Titan to Bartolomé.
3. Return Sun Titan through the Aura.
4. Return the Aura through Sun Titan.
...
- If graveyard hate prevents a combo, grow Bartolomé and use Rogue's Passage.
- Awakening Hall can rebuild the board after a failed attempt.
