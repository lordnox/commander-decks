...
| [**Helm of the Host**](https://scryfall.com/card/msc/200/helm-of-the-host?utm_source=api) | Produces a new nonlegendary [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api) every combat |
...
- [**Patron of the Moon**](https://scryfall.com/card/bok/45/patron-of-the-moon?utm_source=api) converts those returned lands into repeated two-land bursts.
...
| Situation | [**Crop Rotation**](https://scryfall.com/card/dmr/154/crop-rotation?utm_source=api) target |
|---|---|
| Need an immediate extra landfall | A fetch land |
| Need repeatable off-turn landfall | [**Ghost Town**](https://scryfall.com/card/tmp/318/ghost-town?utm_source=api) or [**Thawing Glaciers**](https://scryfall.com/card/vma/318/thawing-glaciers?utm_source=api) |
| Need a reusable land in hand | [**Oboro, Palace in the Clouds**](https://scryfall.com/card/sok/164/oboro-palace-in-the-clouds?utm_source=api) |
| Need token production | [**Field of the Dead**](https://scryfall.com/card/m20/247/field-of-the-dead?utm_source=api) |
| Need self-mill selection | [**Cephalid Coliseum**](https://scryfall.com/card/tdc/349/cephalid-coliseum?utm_source=api) |
| Need a dredgeable land | [**Dakmor Salvage**](https://scryfall.com/card/eoc/156/dakmor-salvage?utm_source=api) |
...
- [**Field of the Dead**](https://scryfall.com/card/m20/247/field-of-the-dead?utm_source=api) and [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api) trigger from the same land. Put the Field trigger above the [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api) triggers so its Zombie exists—and counts under a type changer—before [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api)'s X is calculated.
