...
[**Maskwood Nexus**](https://scryfall.com/card/clb/865/maskwood-nexus?utm_source=api) and [**Arcane Adaptation**](https://scryfall.com/card/xln/46/arcane-adaptation?utm_source=api) make creature cards in the graveyard Crabs as well. A foretold [**Haunting Voyage**](https://scryfall.com/card/ecc/75/haunting-voyage?utm_source=api) naming Crab can therefore return the entire creature package.
...
Protect [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api) first, then the effect that makes the legend rule safe. Do not create unsafe Nantuko copies or deploy [**Machine God's Effigy**](https://scryfall.com/card/brc/16/machine-gods-effigy?utm_source=api) as [Homer](https://scryfall.com/card/mbc/40/homer-the-hermit?utm_source=api) without checking the legend rule.
